...
/** Mock de formulário de perfil (ainda não alinhado ao Usuario da API). */
type PerfilFormUser = {
  id: string;
  nome: string;
  email: string;
  ...
  return (
    <div className="mb-5 w-full text-lg">
      ...
      {editing ? (
        ...
        <p className="bg-gray-100 text-gray-500 font-semibold px-3 py-2 rounded-md w-full min-h-[42px] flex items-center">
          {value}
        </p>
      )}
    </div>
...
const loggedUser: PerfilFormUser = {
  id: "id-123",
  nome: "Gabriel Pinho",
