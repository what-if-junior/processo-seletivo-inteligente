    ...
    return (
      ...
      bg-[#fcfcfc] border-t border-gray-200 shadow-md">
            <div className="grid grid-cols-4 items-center max-w-md mx-auto w-full gap-2">
                <button
                    className="flex flex-col items-center justify-center bg-white rounded-md transition gap-1"
                >
                    <Image
                ...
                <button
                    className="flex flex-col items-center justify-center bg-white rounded-md transition max-w-20"
                >
                    <Image
