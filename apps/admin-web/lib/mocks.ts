...
export const MOCK_INSCRICOES: AdminInscricao[] = [
  {
    ...
    usuario: mockUsers[0],
    curso: cursoInfo(1, "Técnico em Informática", "Campus Brasília", Turno.NOTURNO, 40),
  ...
  },
  {
    ...
    tipo_vaga: TipoVagaCandidatura.PII,
    usuario: mockUsers[1],
    curso: cursoInfo(2, "Licenciatura em Matemática", "Campus Gama", Turno.INTEGRAL, 35),
  ...
  },
  {
    ...
    usuario: mockUsers[0],
    curso: cursoInfo(3, "Técnico em Administração", "Campus Taguatinga", Turno.MATUTINO, 30),
